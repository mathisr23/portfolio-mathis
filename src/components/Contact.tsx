            ...
            <div className="max-w-3xl mx-auto relative z-10">
                ...
                >
                    ...
                    <p className="text-white/60 text-lg max-w-xl mx-auto">
                        Currently open to full-time front-end opportunities.
                    </p>
                    <p className="text-white/40 text-base mt-2">
                        If you're looking for a passionate developer to join your team, let's talk.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        />
                        <span className="relative z-10">Open Email</span>
                        <svg
                            width="20"
                            height="20"
                            viewBox="0 0 20 20"
                ...
                >
                    ...
                    <p className="text-white/30 text-sm">
                        Based in France (CET) · Available for remote positions
                    </p>
                </motion.div>
            </div>
        </section>
